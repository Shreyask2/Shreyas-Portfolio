  ...
  const projects = [
    {
      ...
      description: "An AI-powered solution that monitors environmental conditions using machine learning algorithms to predict and detect anomalies.",
      image: images.projects.mlProject2,
      tech: ["Python", "TensorFlow", "React", "Node.js"],
      github: "https://github.com/yourusername/project1",
      demo: "https://demo-url.com",
      highlights: [
        "Won First Place at AI Hackathon",
